...
source.include_patterns = main.py, src/models/*.py, src/utils/*.py, src/views/mobile_ui/*.py, src/config.py, data/.gitkeep
...
source.exclude_patterns = src/views/ui/*, main_android.py, docs/*, Makefile, profile.md, umstellung.md, README.md, requirements/*, buildozer.spec, venv/*, dist/*, build/*, __pycache__/*, .git/*, .buildozer/*
